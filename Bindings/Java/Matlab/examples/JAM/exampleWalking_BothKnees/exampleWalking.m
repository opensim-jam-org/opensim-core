...
model_file = '../models/healthy/lenhart2015_BothKnees/lenhart2015_BothKnees.osim';
...
secondary_coord = COMAKSecondaryCoordinate();
secondary_coord.setName('/jointset/knee_l/knee_flex_l');
secondary_coord.set_secondary_coordinates(0,'/jointset/knee_l/knee_add_l');
secondary_coord.set_secondary_coordinates(1,'/jointset/knee_l/knee_rot_l');
secondary_coord.set_secondary_coordinates(2,'/jointset/knee_l/knee_tx_l');
secondary_coord.set_secondary_coordinates(3,'/jointset/knee_l/knee_ty_l');
secondary_coord.set_secondary_coordinates(4,'/jointset/knee_l/knee_tz_l');
secondary_coord.set_secondary_coordinates(5,'/jointset/pf_l/pf_flex_l');
secondary_coord.set_secondary_coordinates(6,'/jointset/pf_l/pf_rot_l');
secondary_coord.set_secondary_coordinates(7,'/jointset/pf_l/pf_tilt_l');
secondary_coord.set_secondary_coordinates(8,'/jointset/pf_l/pf_tx_l');
secondary_coord.set_secondary_coordinates(9,'/jointset/pf_l/pf_ty_l');
secondary_coord.set_secondary_coordinates(10,'/jointset/pf_l/pf_tz_l');
secondary_coord.set_secondary_coupled_coordinate('/jointset/knee_l/knee_flex_l');
secondary_coord.set_secondary_coupled_coordinate_start_value(0);
secondary_coord.set_secondary_coupled_coordinate_stop_value(100);
secondary_coord_set.cloneAndAppend(secondary_coord);
